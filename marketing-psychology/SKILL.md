...
version: 1.0.0
description: "Use when the user wants to apply psychological principles, mental models, or behavioral science to marketing. Trigger on \"psychology,\" \"mental models,\" \"cognitive bias,\" \"persuasion,\" \"behavioral science,\" \"why people buy,\" \"decision-making,\" or \"consumer behavior.\" Also use proactively when user is designing copy, pricing, or CTAs and hasn't considered psychological principles. Provides 70+ mental models organized for marketing application."
---
